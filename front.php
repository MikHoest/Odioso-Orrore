...
while ($row = mysqli_fetch_array($result)) {
    ...
    $date=$row['date'];
    echo "<div align='center' style='font-size: 14px; font-family: Verdana'>" . "Date: ". $date. "</div><br>"."<div id='content' align='center' style='font-size: 28px; font-family: Verdana'>" .$title . "</div>"."<br>"."<div align='center' style='font-size: 16px; font-family: Verdana'>" .$description . "</div>";
}
?>
   </div>
