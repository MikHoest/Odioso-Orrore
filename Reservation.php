...
<div class="wrapper popup social" style="margin-left: 25%; height: inherit; align-content: center";>
    <table style=" width: 100%">
        ...
        <tr><th><span class="popuptext" id="myPopup"><p class="customfont" style="font-size: 30px; font-weight: bold; text-align: left; color: black;">Time <p class="customfont" style="font-size: 15px; text-align: left; color: black;">no reservation needed between 13:00-17:00 and after 21:00</p><th><input list="browsers" name="fromTime" id="datepicker" required><datalist id="browsers"><option value="11:00"><option value="11:30"><option value="12:00"><option value="12:30"><option value="13:00"><option value="17:00"><option value="17:30"><option value="18:00"><option value="18:30"><option value="19:00"><option value="19:30"><option value="20:00"><option value="20:30"><option value="21:00"></option> </datalist></p></span></th></tr>
        <tr><th><span class="popuptext" id="myPopup"><p class="customfont" style="font-size: 30px; font-weight: bold; text-align: left; color: black;">Number Of Guests <p class="customfont" style="font-size: 15px; text-align: left; color: black;">For groups larger then 8 please call and reserve</p><th><input type="number" name="numberGuest" min="1" max="8" required></p></span></th></tr>
